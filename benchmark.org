...
First we need to declare our globals, in this case, the number of simulations we will run.
Obviously the more simulations we run the more precise the results will be.
